...
ana_hotspot("p_msp1", plot_it = TRUE)
...
joe <- function(var = "p_p5",
                ...
                dfs = df_spatial){ # change the background by looking here: https://leaflet-extras.github.io/leaflet-providers/preview/
...
joe('pcr_mujer', hot = TRUE, cold = TRUE, cluster_outline = FALSE,circle_outline = FALSE, use_leaflet = TRUE)

joe('mic_mujer', hot = TRUE, cold = TRUE, cluster_outline = FALSE,circle_outline = FALSE, use_leaflet = TRUE)
...
joe('p_msp1', hot = TRUE, cold = FALSE, cluster_outline = FALSE, circle_outline = TRUE, use_leaflet = TRUE)
...
joe('p_ama1', hot = TRUE, cold = FALSE, cluster_outline = FALSE, circle_outline = TRUE, use_leaflet = TRUE)
...
joe('pcr_mujer', hot = TRUE, cold = FALSE, cluster_outline = TRUE, use_leaflet = TRUE, background = 'Esri.WorldImagery', circle_outline = FALSE)
